...
RUN_CONFIG="${RUN_CONFIG:-qwen34b_gen1024_fixteacher_temp11_mask_position}"
LOG_FILE="${LOG_FILE:-opsd_4b_mask_position_train.log}"
...
echo "Started mask-position OPSD 4B training."
