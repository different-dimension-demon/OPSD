...
RUN_CONFIG="${RUN_CONFIG:-qwen34b_gen1024_fixteacher_temp11_privilege_slot}"
LOG_FILE="${LOG_FILE:-opsd_4b_privilege_slot_train.log}"
MAIN_PROCESS_PORT="${MAIN_PROCESS_PORT:-12962}"
...
echo "Started privilege-slot OPSD 4B training."
